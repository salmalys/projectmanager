...
CREATE TABLE IF NOT EXISTS "Projet" (
	...
	UNIQUE ("Nom_Matiere", "Sujet")
);

CREATE TABLE IF NOT EXISTS "BinomeProjet" (
	"ID_BinomeProjet"	INTEGER NOT NULL,
	"ID_Etudiant1"	INTEGER NOT NULL,
	"ID_Etudiant2"	INTEGER, --optionnel
	"ID_Projet"	INTEGER NOT NULL,
	...
	UNIQUE("ID_Etudiant1", "ID_ETudiant2", "ID_Projet")
);
...
CREATE TABLE IF NOT EXISTS "Notes" (
	...
	"Note_Soutenance_Etudiant2"	FLOAT CHECK("Note_Soutenance_Etudiant2" BETWEEN 0 AND 20), --optionnel 
